  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Overview dashboard: real-time stats, cluster status, and API key management in one screen.",
      ...
      },
      {
        ...
        steps: [
          ...
          "Copy your API key from Overview → API Keys. This key authenticates all requests to the platform.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Usage",
        steps: [
          "Navigate to Overview → Settings → Context Templates.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Monitor usage in Overview → Analytics. The usage dashboard shows daily trends and remaining quota.",
